...
public class SpeechRecognitionAzul : MonoBehaviour
{
    ...
    private CamareroAzulController CamareroController;
    ...
    void Start()
    {
        CamareroController = GetComponent<CamareroAzulController>();
        ...
        */
        ...
        palabrasAccion.Add("azul A dos", CamareroController.AzulAdos);
        palabrasAccion.Add("azul A tres", CamareroController.AzulAtres);
        palabrasAccion.Add("azul A cuatro", CamareroController.AzulAcuatro);
        palabrasAccion.Add("azul A cinco", CamareroController.AzulAcinco);
        palabrasAccion.Add("azul A seis", CamareroController.AzulAseis);

        palabrasAccion.Add("azul B uno", CamareroController.AzulBuno);
        palabrasAccion.Add("azul B dos", CamareroController.AzulBdos);
        palabrasAccion.Add("azul B tres", CamareroController.AzulBtres);
        palabrasAccion.Add("azul B cuatro", CamareroController.AzulBcuatro);
        palabrasAccion.Add("azul B cinco", CamareroController.AzulBcinco);
        palabrasAccion.Add("azul B seis", CamareroController.AzulBseis);

        palabrasAccion.Add("azul C uno", CamareroController.AzulCuno);
        palabrasAccion.Add("azul C dos", CamareroController.AzulCdos);
        palabrasAccion.Add("azul C tres", CamareroController.AzulCtres);
        palabrasAccion.Add("azul C cuatro", CamareroController.AzulCcuatro);
        palabrasAccion.Add("azul C cinco", CamareroController.AzulCcinco);
        palabrasAccion.Add("azul C seis", CamareroController.AzulCseis);

        palabrasAccion.Add("azul D uno", CamareroController.AzulDuno);
        palabrasAccion.Add("azul D dos", CamareroController.AzulDdos);
        palabrasAccion.Add("azul D tres", CamareroController.AzulDtres);
        palabrasAccion.Add("azul D cuatro", CamareroController.AzulDcuatro);
        palabrasAccion.Add("azul D cinco", CamareroController.AzulDcinco);
        palabrasAccion.Add("azul D seis", CamareroController.AzulDseis);
